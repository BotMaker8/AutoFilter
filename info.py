...
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002018591948')
...
DATA_BASE_CHANNEL = [int(ch) for ch in (environ.get('DATA_BASE_CHANNEL', '-1002114948791')).split()]
